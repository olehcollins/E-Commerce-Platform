...
exports.Phones = [
    ...
    },
    {
        name: "Iphone 14 Pro",
        category: "Phones",
        image: "https://images.unsplash.com/photo-1679027554905-26e911504796?q=80&w=3164&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        price: 910.4,
        countInStock: 205,
        brand: "Apple",
        description: "The latest iPhone, the iPhone 14 pro, features a 6.1-inch Super Retina XDR display with a resolution of 2532 x 1170 pixels. It is powered by Apple's A15 Bionic chip with a 6-core CPU, 5-core GPU, and a 16-core Neural Engine. The device comes with various storage options, including 128GB, 256GB, and 512GB. The dual-camera system includes a 12MP wide and a 12MP ultra-wide lens, while the front camera is a 12MP TrueDepth camera. The iPhone 14 supports 5G connectivity, Face ID, and runs on iOS 15. It is water and dust resistant with an IP68 rating and offers improved battery life with up to 20 hours of video playback.",
        reviews: [
    ...
    },
    {
        name: "iPhone X",
        category: "Phones",
        image: "https://images.unsplash.com/photo-1510166150654-85d6103a2414?q=80&w=2780&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        price: 799.0,
        countInStock: Math.floor(Math.random() * 100) + 200,
        brand: "Apple",
        description: "The iPhone X features a stunning 5.8-inch Super Retina display, advanced Face ID for secure authentication, and the powerful A11 Bionic chip for smooth performance. With its dual-camera system and wireless charging capability, it offers a seamless user experience.",
        reviews: [
            {
                customer: "John",
    ...
    },
    {
        name: "iPhone 8",
        category: "Phones",
        image: "https://images.unsplash.com/photo-1505156868547-9b49f4df4e04?q=80&w=2263&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        price: 599.0,
        countInStock: Math.floor(Math.random() * 100) + 200,
        brand: "Apple",
        description: "The iPhone 8 features a 4.7-inch Retina HD display, A11 Bionic chip, and advanced camera system for stunning photos and videos. With wireless charging capability and water and dust resistance, it's designed to withstand everyday use.",
        reviews: [
            {
                customer: "Michael",
    ...
    },
    {
        name: "iPhone 11 Pro",
        category: "Phones",
        image: "https://images.unsplash.com/photo-1571380401583-72ca84994796?q=80&w=3024&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        price: 999.0,
        countInStock: Math.floor(Math.random() * 100) + 200,
        brand: "Apple",
        description: "The iPhone 11 Pro features a 5.8-inch Super Retina XDR display, triple-camera system, and A13 Bionic chip for unparalleled performance. With its all-day battery life and water and dust resistance, it's the ultimate iPhone for power users.",
        reviews: [
            {
                customer: "Sophia",
